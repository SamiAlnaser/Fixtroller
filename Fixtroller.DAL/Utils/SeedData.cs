    ...
    public class SeedData : ISeedData
    {
                ...
                var problemTypes = new List<ProblemType>
        {
            ...
            if (!await _context.MaintenanceRequests.AnyAsync())
            {
                ...
                // نبني الطلبات أولاً (بدون أي حقول تعيين قديمة)
                var r1 = new MaintenanceRequest
                {
