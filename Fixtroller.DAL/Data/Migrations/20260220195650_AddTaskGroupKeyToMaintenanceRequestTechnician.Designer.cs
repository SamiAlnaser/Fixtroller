...
namespace Fixtroller.DAL.Data.Migrations
{
    ...
    [Migration("20260220195650_AddTaskGroupKeyToMaintenanceRequestTechnician")]
    partial class AddTaskGroupKeyToMaintenanceRequestTechnician
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fixtroller.DAL.Entities.AIChat.AiEmployeeChatSettingsEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsEmployeeEnabled")
                        .HasColumnType("bit");

                    b.Property<bool>("IsTechnicianEnabled")
                        .HasColumnType("bit");

                    b.HasKey("Id");

                    b.ToTable("AiEmployeeChatSettings");
                });

            modelBuilder.Entity("Fixtroller.DAL.Entities.Announcements.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fixtroller.DAL.Entities.Announcements.AnnouncementImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fixtroller.DAL.Entities.MaintenanceRequestEntity.MaintenanceNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fixtroller.DAL.Entities.MaintenanceRequestEntity.MaintenanceRequestImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fixtroller.DAL.Entities.MaintenanceRequestEntity.WorkTimeEntry", b =>
                {
                    ...
                    b.ToTable("WorkTimeEntry", (string)null);
                });

            modelBuilder.Entity("Fixtroller.DAL.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fixtroller.DAL.Entities.Announcements.AnnouncementImage", b =>
                {
                    b.HasOne("Fixtroller.DAL.Entities.Announcements.Announcement", "Announcement")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Fixtroller.DAL.Entities.MaintenanceRequestEntity.MaintenanceNote", b =>
                {
                    ...
                    b.HasOne("Fixtroller.DAL.Entities.MaintenanceRequestEntity.MaintenanceRequest", "MaintenanceRequest")
                        .WithMany("Notes")
            ...
            modelBuilder.Entity("Fixtroller.DAL.Entities.MaintenanceRequestEntity.MaintenanceRequest", b =>
                {
                    ...
                    b.HasOne("Fixtroller.DAL.Entities.ApplicationUser", "OwnerUser")
            ...
            modelBuilder.Entity("Fixtroller.DAL.Entities.Notification", b =>
                {
                    b.HasOne("Fixtroller.DAL.Entities.ApplicationUser", "User")
                        .WithMany()
